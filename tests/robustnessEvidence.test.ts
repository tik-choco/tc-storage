...
import { createInitialSnapshot, makeFileFromDataUrl, makeFolder, stripFileContent, type FileRecord, type FolderRecord, type StorageSnapshot } from '../src/storage/domain.js'
