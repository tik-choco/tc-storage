...
import { createInitialSnapshot, makeFileFromDataUrl, makeFolder, stripFileContent, type StorageSnapshot } from '../src/storage/domain.js'
import { stampFilePatch, stampFolderPatch } from '../src/storage/crdt.js'
import type { BroadcastSharePayload } from '../src/p2p/p2pTypes.js'
