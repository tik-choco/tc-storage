...
import { createDragDropActions } from '../src/app/appDragDropActions.js'
import { compareFilesForDisplay, compareFoldersForDisplay, createInitialSnapshot, makeFileFromDataUrl, makeFolder, type FileRecord, type FolderRecord, type StorageSnapshot } from '../src/storage/domain.js'
