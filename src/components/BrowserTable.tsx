...
export function FileTable(props: BrowserTableProps) {
  ...
  if (props.viewMode === 'grid') {
    return (
      <div {...tableProps} class={`table table-grid drop-zone ${marquee ? 'marquee-active' : ''} ${props.dragActive ? 'drag-active' : ''} ${isCurrentDropTarget ? 'drop-target' : ''}`} role="list" aria-label="Files and folders" onDragEnter={props.onDrag} onDragOver={props.onDrag} onDragLeave={props.onDrag} onDrop={props.onDrop}>
        ...
        {props.folderRows.map((folder) => <FolderTile selected={selection.isItemSelected({ type: 'folder', id: folder.id })} dragItem={props.dragItem} dropTargetFolderId={props.dropTargetFolderId} folder={folder} files={props.files} reorderTarget={props.reorderTarget} onDeleteFolder={props.onDeleteFolder} onDownloadFolder={props.onDownloadFolder} onDragEnd={props.onItemDragEnd} onDragStart={props.onItemDragStart} onItemDragLeave={props.onBrowserItemDragLeave} onItemDragOver={props.onBrowserItemDragOver} onItemDrop={props.onBrowserItemDrop} onSelectFolder={props.onSelectFolder} onShowFolderDetails={props.onShowFolderDetails} key={folder.id} />)}
  ...
  return (
    <div {...tableProps} class={`table drop-zone ${marquee ? 'marquee-active' : ''} ${props.dragActive ? 'drag-active' : ''} ${isCurrentDropTarget ? 'drop-target' : ''}`} role="table" aria-label="Files and folders" onDragEnter={props.onDrag} onDragOver={props.onDrag} onDragLeave={props.onDrag} onDrop={props.onDrop}>
      ...
      {props.folderRows.map((folder) => <FolderRow selected={selection.isItemSelected({ type: 'folder', id: folder.id })} dragItem={props.dragItem} dropTargetFolderId={props.dropTargetFolderId} folder={folder} files={props.files} reorderTarget={props.reorderTarget} onDeleteFolder={props.onDeleteFolder} onDownloadFolder={props.onDownloadFolder} onDragEnd={props.onItemDragEnd} onDragStart={props.onItemDragStart} onItemDragLeave={props.onBrowserItemDragLeave} onItemDragOver={props.onBrowserItemDragOver} onItemDrop={props.onBrowserItemDrop} onSelectFolder={props.onSelectFolder} onSelectItem={selection.toggleItemSelection} onShowFolderDetails={props.onShowFolderDetails} key={folder.id} />)}
