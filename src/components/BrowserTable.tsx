...
import { pendingShareKey, type BrowserDragItem } from '../app/appTypes.js'
import { emptySelectionActions } from '../app/appSelectionActions.js'
...
export function FileTable(props: BrowserTableProps) {
  ...
  if (props.viewMode === 'grid') {
    return (
      <div {...tableProps} class={`table table-grid drop-zone ${marquee ? 'marquee-active' : ''} ${props.dragActive ? 'drag-active' : ''} ${isCurrentDropTarget ? 'drop-target' : ''}`} role="list" aria-label="Files and folders" onDragEnter={props.onDrag} onDragOver={props.onDrag} onDragLeave={props.onDrag} onDrop={props.onDrop}>
        ...
        {props.pendingFolderShares.map((share) => <PendingFolderShareTile busy={Boolean(share.cid) && props.busy === `import-${share.cid}`} progress={props.shareImportProgress[pendingShareKey(share)]} share={share} onCancelShare={props.onCancelPendingShare} key={pendingShareKey(share)} />)}
        {props.folderRows.map((folder) => <FolderTile selected={selection.isItemSelected({ type: 'folder', id: folder.id })} selectionActive={selection.selectedCount > 0} dragItem={props.dragItem} dropTargetFolderId={props.dropTargetFolderId} folder={folder} files={props.files} fileDataUrls={props.fileDataUrls} reorderTarget={props.reorderTarget} shareBusy={props.busy === 'share'} onDeleteFolder={props.onDeleteFolder} onDownloadFolder={props.onDownloadFolder} onDragEnd={props.onItemDragEnd} onDragStart={props.onItemDragStart} onItemDragLeave={props.onBrowserItemDragLeave} onItemDragOver={props.onBrowserItemDragOver} onItemDrop={props.onBrowserItemDrop} onSelectFolder={props.onSelectFolder} onSelectItem={selection.toggleItemSelection} onShareFolder={props.onShareFolder} onShowFolderDetails={props.onShowFolderDetails} key={folder.id} />)}
        {props.fileRows.map((file) => <FileTile selected={selection.isItemSelected({ type: 'file', id: file.id })} selectionActive={selection.selectedCount > 0} busy={props.busy === `file-share-${file.id}`} dataUrl={props.fileDataUrls[file.id]} dragItem={props.dragItem} file={file} progress={props.fileLoadProgress[file.id]} reorderTarget={props.reorderTarget} onDeleteFile={props.onDeleteFile} onDownloadFile={props.onDownloadFile} onDragEnd={props.onItemDragEnd} onDragStart={props.onItemDragStart} onItemDragLeave={props.onBrowserItemDragLeave} onItemDragOver={props.onBrowserItemDragOver} onItemDrop={props.onBrowserItemDrop} onOpenFile={props.onOpenFile} onPreloadFile={props.onPreloadFile} onSelectItem={selection.toggleItemSelection} onShareFile={props.onShareFile} onShowFileDetails={props.onShowFileDetails} key={file.id} />)}
  ...
  return (
    <div {...tableProps} class={`table drop-zone ${marquee ? 'marquee-active' : ''} ${props.dragActive ? 'drag-active' : ''} ${isCurrentDropTarget ? 'drop-target' : ''}`} role="table" aria-label="Files and folders" onDragEnter={props.onDrag} onDragOver={props.onDrag} onDragLeave={props.onDrag} onDrop={props.onDrop}>
      ...
      {props.pendingFolderShares.map((share) => <PendingFolderShareRow busy={Boolean(share.cid) && props.busy === `import-${share.cid}`} progress={props.shareImportProgress[pendingShareKey(share)]} share={share} onCancelShare={props.onCancelPendingShare} key={pendingShareKey(share)} />)}
      {props.folderRows.map((folder) => <FolderRow selected={selection.isItemSelected({ type: 'folder', id: folder.id })} dragItem={props.dragItem} dropTargetFolderId={props.dropTargetFolderId} folder={folder} files={props.files} fileDataUrls={props.fileDataUrls} reorderTarget={props.reorderTarget} shareBusy={props.busy === 'share'} onDeleteFolder={props.onDeleteFolder} onDownloadFolder={props.onDownloadFolder} onDragEnd={props.onItemDragEnd} onDragStart={props.onItemDragStart} onItemDragLeave={props.onBrowserItemDragLeave} onItemDragOver={props.onBrowserItemDragOver} onItemDrop={props.onBrowserItemDrop} onSelectFolder={props.onSelectFolder} onSelectItem={selection.toggleItemSelection} onShareFolder={props.onShareFolder} onShowFolderDetails={props.onShowFolderDetails} key={folder.id} />)}
      {props.fileRows.map((file) => <FileRow selected={selection.isItemSelected({ type: 'file', id: file.id })} busy={props.busy === `file-share-${file.id}`} dragItem={props.dragItem} file={file} progress={props.fileLoadProgress[file.id]} reorderTarget={props.reorderTarget} onDeleteFile={props.onDeleteFile} onDownloadFile={props.onDownloadFile} onDragEnd={props.onItemDragEnd} onDragStart={props.onItemDragStart} onItemDragLeave={props.onBrowserItemDragLeave} onItemDragOver={props.onBrowserItemDragOver} onItemDrop={props.onBrowserItemDrop} onOpenFile={props.onOpenFile} onSelectItem={selection.toggleItemSelection} onShareFile={props.onShareFile} onShowFileDetails={props.onShowFileDetails} key={file.id} />)}
