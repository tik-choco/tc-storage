...
export function FileTable(props: BrowserTableProps) {
  ...
  if (props.viewMode === 'grid') {
    return (
      <div class={`table table-grid drop-zone ${props.dragActive ? 'drag-active' : ''} ${isCurrentDropTarget ? 'drop-target' : ''}`} role="list" aria-label="Files and folders" onDragEnter={props.onDrag} onDragOver={props.onDrag} onDragLeave={props.onDrag} onDrop={props.onDrop}>
        ...
        {props.folderRows.map((folder) => <FolderTile dragItem={props.dragItem} dropTargetFolderId={props.dropTargetFolderId} folder={folder} files={props.files} reorderTarget={props.reorderTarget} onCopy={props.onCopy} onDeleteFolder={props.onDeleteFolder} onDragEnd={props.onItemDragEnd} onDragStart={props.onItemDragStart} onItemDragLeave={props.onBrowserItemDragLeave} onItemDragOver={props.onBrowserItemDragOver} onItemDrop={props.onBrowserItemDrop} onSelectFolder={props.onSelectFolder} onShowFolderDetails={props.onShowFolderDetails} key={folder.id} />)}
  ...
  return (
    <div class={`table drop-zone ${props.dragActive ? 'drag-active' : ''} ${isCurrentDropTarget ? 'drop-target' : ''}`} role="table" aria-label="Files and folders" onDragEnter={props.onDrag} onDragOver={props.onDrag} onDragLeave={props.onDrag} onDrop={props.onDrop}>
      ...
      {props.folderRows.map((folder) => <FolderRow dragItem={props.dragItem} dropTargetFolderId={props.dropTargetFolderId} folder={folder} files={props.files} reorderTarget={props.reorderTarget} onCopy={props.onCopy} onDeleteFolder={props.onDeleteFolder} onDragEnd={props.onItemDragEnd} onDragStart={props.onItemDragStart} onItemDragLeave={props.onBrowserItemDragLeave} onItemDragOver={props.onBrowserItemDragOver} onItemDrop={props.onBrowserItemDrop} onSelectFolder={props.onSelectFolder} onShowFolderDetails={props.onShowFolderDetails} key={folder.id} />)}
      {props.fileRows.map((file) => <FileRow busy={props.busy === `file-share-${file.id}`} dragItem={props.dragItem} file={file} reorderTarget={props.reorderTarget} onDeleteFile={props.onDeleteFile} onDragEnd={props.onItemDragEnd} onDragStart={props.onItemDragStart} onItemDragLeave={props.onBrowserItemDragLeave} onItemDragOver={props.onBrowserItemDragOver} onItemDrop={props.onBrowserItemDrop} onOpenFile={props.onOpenFile} onShareFile={props.onShareFile} onShowFileDetails={props.onShowFileDetails} onToggleStar={props.onToggleStar} key={file.id} />)}
