...
import type { DownloadProgress, Notice } from '../app/appTypes.js'
import { formatBytes } from '../storage/domain.js'
import type { NetworkState } from '../p2p/p2p.js'
  ...
  return (
    <footer class="status-bar">
      <div class="status-network" title={props.networkState.lastEvent}>
        <Wifi size={14} />
        <a href="https://github.com/tik-choco-lab/mistlib" target="_blank" rel="noreferrer noopener"><strong>mistlib</strong></a>
