...
import { addActivity, compareFilesForDisplay, compareFoldersForDisplay, touchSnapshot, type FileRecord, type FolderRecord, type StorageSnapshot } from '../storage/domain.js'
import { hasBrowserDragItem, hasExternalFiles, readBrowserDragItems, writeBrowserDragItems } from '../util/dragDrop.js'
