import { childFolders, compareFilesForDisplay, type FileRecord, type FolderRecord, type StorageSnapshot } from '../storage/domain.js'
import type { ZipEntry } from '../util/zip.js'
