...
export function useAppController() {
  ...
  const dragDrop = createDragDropActions({ browserViewMode, currentFolderId, dragItemRef, dragItemsRef, moveActions, scheduleFolderSync: folderSync.scheduleFolderSync, selectedItems, setDragActive, setDragItem, setDropTargetFolderId, setNotice, setReorderTarget, setSelectedItems, setSnapshot, settings, snapshotRef, uploadFiles: fileActions.uploadFiles })
