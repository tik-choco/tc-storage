...
export function useAppController() {
  ...
  const folderActions = createFolderActions({ announceFolderChange: folderSync.announceFolderChange, clearFolderSyncTimer: folderSync.clearFolderSyncTimer, currentFolder, currentFolderId, currentFolderKey, ensureFolderFilesStored: fileContent.ensureFolderFilesStored, folderKeysRef, folderPanelFolder, folderPanelFolderId, folders, movePopover: panel.movePopover, networkRef, setBusy, setCurrentFolderId, setDeleteRequest, setDetailFileId, setExpandedPreviewOpen, setFolderKeys, setFolderNameDraft, setFolderPanelFolderId, setFolderPanelOpen, setNotice, setProfileOpen, setSelectedFileId, setSettingsOpen, setSnapshot, settings, shareProfile, snapshot, snapshotRef, syncSignaturesRef })
  const moveActions = createMoveActions({ announceFolderChange: folderSync.announceFolderChange, ensureFileContent: fileContent.ensureFileContent, folderKeysRef, setBusy, setFileContentCache, setFolderKeys, setNotice, setSnapshot, settings, snapshotRef })
  const fileActions = createFileActions({ announceFolderChange: folderSync.announceFolderChange, currentFolderId, deleteFolder: folderActions.deleteFolder, deleteRequest, ensureFileContent: fileContent.ensureFileContent, fileShareKeys, folderKeysRef, folders, networkRef, setBusy, setCurrentFolderId, setDeleteRequest, setDetailFileId, setFileContentCache, setFileShareKeys, setFolderKeys, setFolderPanelOpen, setNotice, setProfileOpen, setSelectedItems, setSettingsOpen, setSnapshot, settings, shareProfile, snapshot, snapshotRef })
  ...
  const dragDrop = createDragDropActions({ browserViewMode, currentFolderId, dragItemRef, dragItemsRef, moveActions, selectedItems, setDragActive, setDragItem, setDropTargetFolderId, setNotice, setReorderTarget, setSelectedItems, setSnapshot, settings, snapshotRef, uploadFiles: fileActions.uploadFiles })
