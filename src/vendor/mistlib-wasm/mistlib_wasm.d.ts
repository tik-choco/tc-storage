...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h363959a4d9c0960a: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__hc78b9a8ef5871be7: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h36584e9320caae5c: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h30b9ca29ae182cf8: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h1b6d27bb48c02378: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h232f6ce52dcddfa8: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h232f6ce52dcddfa8_1: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h232f6ce52dcddfa8_2: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h232f6ce52dcddfa8_3: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h232f6ce52dcddfa8_4: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h349daea80ae102d7: (a: number, b: number) => void;
